...
\begin{figure*}[!ht]
  ...
  \vskip\baselineskip
  \begin{subfigure}[b]{0.475\linewidth}
    \centering\includegraphics[scale=0.4]{figures/naca0012vtlines.png} 
...
\begin{figure*}[!ht]
  ...
  \vskip\baselineskip
  \begin{subfigure}[b]{0.475\linewidth}
    \centering\includegraphics[scale=0.4]{figures/sc20614vtlines.png} 
    %\caption{\label{fig:sc20614q}}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.475\linewidth}
    \centering\includegraphics[scale=0.4]{figures/sc20614cplines.png} 
...
\begin{figure*}[!ht]
  ...
  \vskip\baselineskip
  \begin{subfigure}[b]{0.475\linewidth}
    \centering\includegraphics[scale=0.4]{figures/zone40vtlines.png} 
    %\caption{\label{fig:zoneq}}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.475\linewidth}
    \centering\includegraphics[scale=0.4]{figures/zone40cplines.png} 
