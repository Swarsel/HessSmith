...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \caption{\subref{fig:theoreticalcylinder}) Abweichung der Druckbeiwerte eines achtseitigen Zylinders vom theoretisch ermittelten Wert \subref{fig:absoluteerror}) Graph der Abweichung des Relativen Fehlers vom exaken Wert.}
\end{figure}
