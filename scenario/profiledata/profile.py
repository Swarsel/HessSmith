...
class AirfoilProfile:
    ...
    def plot(self, height=8, width=5, sort=False, normalvectors=False, scaled=False):
        ...
        ax2.plot(xl[:-1], thetau, color='g', linestyle=':',  linewidth=2, label='Oberseite')
        ax2.plot(xl[:-1], thetal, color='k', linestyle=':', linewidth=2, label='Unterseite')
        ...
        ll.reverse()
        # lu.append(ll[0])
        ax3.plot(xl[:-1], lu, color='g', linestyle=':',  linewidth=2, label='Oberseite')
        ax3.plot(xl[:-1], ll, color='k', linestyle=':', linewidth=2, label='Unterseite')
